...
1. Choix avec Massy : hébergeur — **Cloudflare Pages en premier choix** (bande passante
   illimitée gratuite, décision infra du 05/07 dans CLAUDE.md), Vercel/Netlify en alternative.
   Sous-domaine gratuit pour l'instant (pas d'achat de domaine avant la mise en vente).
